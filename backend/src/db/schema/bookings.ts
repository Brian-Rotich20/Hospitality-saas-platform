...
export const bookings = pgTable('bookings', {
  ...
  // ✅ Pricing snapshot — store at time of booking so price changes don't affect existing bookings
  pricingType: varchar('pricing_type', { length: 20 }).notNull(), // snapshot from listing
